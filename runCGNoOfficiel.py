...
CG_no = [[1,0,0.75],[0,0.9,0.85],[0.75,0.75,0.85]]
matrices = [np.array(CG_no), np.array(CG_no)]
...
axes[0].set_ylabel("Mean cumulative regret $R(t)$")
plt.tight_layout()
fig.savefig("Workshop/Figure/Figure v3/CG_non_officel_ucb_pair.pdf", dpi=300, bbox_inches="tight")
plt.close(fig)
