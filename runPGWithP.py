...
# with penalty
PG_wp = [[1,0.1,0],[0.1,0.28,0.1],[0,0.1,1]]
matrices = [np.array(PG_wp), np.array(PG_wp)]
...
axes[0].set_ylabel("Mean cumulative regret $R(t)$")
plt.tight_layout()
fig.savefig("Workshop/Figure/Figure v3/PG_WP_ucb_pair_28.pdf", dpi=300, bbox_inches="tight")
plt.close(fig)
