...
def main():
    ...
    # win_rate = [0.5, 0.4]
    #
    # result = Execute(300, 1000, 4, 1.5, "TUCB").getBanditResult(win_rate, False)
    ...
    #
    # result = Execute(500, 1000, 11, 1.5, "TUCB").getBanditResult(win_rate, False)
    # avg = np.array(result['avg'])
    # std = np.array(result['std'])
    ...
    #
    # result = Execute(5000, 1000, 2, 1.5, "TUCB").getPDResult(matrices)
    # prop = np.array(result['prop'])
